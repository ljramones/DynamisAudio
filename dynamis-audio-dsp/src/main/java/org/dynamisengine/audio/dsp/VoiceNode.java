...
public final class VoiceNode {
    ...
    public void setAsset(AudioAsset asset) {
        ...
        if (asset.sampleRate() != AcousticConstants.SAMPLE_RATE) {
            this.asset = new org.dynamisengine.audio.simulation.ResamplingAudioAsset(asset);
        } else {
            this.asset = asset;
        }
    }

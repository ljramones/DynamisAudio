package org.dynamisengine.audio.designer;

import org.dynamisengine.audio.api.AcousticMaterial;
import org.dynamisengine.audio.api.RtpcParameter;
...
public final class HotReloadManager {
    ...
    public void reloadAcousticMaterial(long entityId, int newMaterialId,
        ...
        try {
            for (int band = 0; band < org.dynamisengine.audio.api.AcousticConstants.ACOUSTIC_BAND_COUNT;
                 band++) {
